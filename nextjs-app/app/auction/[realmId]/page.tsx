...
import AuctionSidebar from '@/components/auction/sidebar/AuctionSidebar';
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <main className="flex-1">
          ...
          {representativeItemsToDisplay.length === 0 && !isLoading && 
            <p className="text-center py-8 text-gray-500">표시할 아이템이 없습니다.</p>
          }
        </main>
      </div>
